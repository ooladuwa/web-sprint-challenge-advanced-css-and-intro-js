...
Because people approach how they view things on the web in different ways because of challenges they may have, we, as developers need to be sure that they are indeed able to access and make use of our site. That is why accessibility is important.

2. Talk about 3 different things you can do to ensure your website is accessible.
   color schemes, alt image descriptions, media queries.

3. How would you explain the concept of a variable to someone new to programming?
   a variable is a like a box that we can use to store information.

4. What is the purpose of using functions in code?
   so that we don't have to keep repeating ourselves.
